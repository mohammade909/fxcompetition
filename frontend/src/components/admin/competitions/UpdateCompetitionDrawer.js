...
import { updateCompetition, getCompetitionDetails } from "../../../actions/competitions";

const UpdateCompetitionDrawer = ({ open, setOpen, competitionId }) => {
  ...
  const onSubmit = (values) => {
    dispatch(updateCompetition({ id: competitionId, updatedData: values }));
    setOpen(false);
  };

  // Format the competition dates to "yyyy-MM-dd" before passing to Formik
...
export default UpdateCompetitionDrawer;
